...
public class SanPhamService {
    ...
    public HinhAnhBienThe uploadAnhBienThe(Long bienTheId, MultipartFile file,
        ...
        return hinhAnhBienTheRepository.save(hinhAnh);
    }

    /**
     * Upload/cập nhật ảnh chính cho sản phẩm
     */
    public SanPham uploadAnhSanPham(Long sanPhamId, MultipartFile file, String uploadDir) throws IOException {
        SanPham sanPham = sanPhamRepository.findById(sanPhamId)
                .orElseThrow(() -> new RuntimeException("Không tìm thấy sản phẩm"));
    ...
    public List<BienThe> danhSachBienTheCuaSanPham(Long sanPhamId) {
        // Chỉ lấy các biến thể đang hoạt động

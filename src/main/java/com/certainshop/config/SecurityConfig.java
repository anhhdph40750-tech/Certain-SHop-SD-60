        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/gio-hang/**", "/api/dat-hang/**",
                        ...
                        "/api/dia-chi/**").hasAnyRole("KHACH_HANG", "ADMIN", "NHAN_VIEN", "SUPER_ADMIN")

                // Admin + Nhân viên
                .requestMatchers("/api/quan-ly/**").hasAnyRole("ADMIN", "NHAN_VIEN", "SUPER_ADMIN")
                ...
                .requestMatchers("/gio-hang/**", "/dat-hang/**", "/tai-khoan/**",
                        "/don-hang/cua-toi/**").hasAnyRole("KHACH_HANG", "ADMIN", "NHAN_VIEN", "SUPER_ADMIN")
                .requestMatchers("/quan-ly/**").hasAnyRole("ADMIN", "NHAN_VIEN", "SUPER_ADMIN")
